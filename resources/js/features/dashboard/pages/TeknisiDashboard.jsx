...
const TeknisiDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (teknisiSchedulesQuery.isError) {
            console.error(
                "Error fetching teknisi data:",
                teknisiSchedulesQuery.error
            );
        ...
        if (teknisiSchedulesQuery.data) {
            ...
            const stats = {
                ...
                completedInspections: schedules.filter((s) => s.is_completed)
                    .length,
                ...
                thisWeekSchedules: schedules.filter((s) => {
                    const { start } = getScheduleWindow(s);
                    return (
                        start && start >= thisWeekStart && start <= thisWeekEnd
                    );
                }).length,
        ...
        user,
        teknisiSchedulesQuery.data,
        teknisiSchedulesQuery.isLoading,
        teknisiSchedulesQuery.isError,
    ]);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Jadwal yang ditugaskan kepada Anda
                                </p>
                            </div>
                            <Link
                                to="/schedules"
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Jadwal yang perlu segera ditangani
                                </p>
                            </div>
                        </div>
                            ...
                            {upcomingDeadlines.length > 0 ? (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm text-gray-400">
                                        Semua jadwal sudah terjadwal dengan baik
                                    </p>
                                </div>
                            )}
                        </div>
                ...
                <div className="mt-8 bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Overview jadwal untuk minggu ini dan minggu depan
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="text-center p-4 bg-blue-50 rounded-xl border border-blue-200">
                            ...
                            <p className="text-2xl font-bold text-blue-600">
                                {teknisiStats.thisWeekSchedules}
                            </p>
                            <p className="text-sm text-gray-600 mt-1">
                                Jadwal Minggu Ini
                            </p>
                        ...
                        <div className="text-center p-4 bg-green-50 rounded-xl border border-green-200">
                            ...
                            <p className="text-2xl font-bold text-green-600">
                                {teknisiStats.nextWeekSchedules}
                            </p>
                            <p className="text-sm text-gray-600 mt-1">
                                Jadwal Minggu Depan
                            </p>
