            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        disabled={disabled}
                        className={`w-full border ${hasError('notification_interval') ? 'border-red-500' : 'border-gray-300'} rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 disabled:bg-gray-100 disabled:cursor-not-allowed`}
                    />
