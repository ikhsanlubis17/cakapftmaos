        ...
        <div className="space-y-6 pb-20">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Riwayat Inspeksi Saya</h1>
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                            ...
                                            {inspection.photo_url && (
                                                ...
                                                >
                                                    <img
                                                        ...
                                                        alt="Foto APAR"
                                                        className="w-20 h-20 object-cover rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all"
                                                    />
                                                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/20 rounded-lg">
                                                        <EyeIcon className="h-6 w-6 text-white drop-shadow-lg" />
                                                    </div>
                                                    <span className="absolute bottom-1 left-1 text-[10px] font-medium text-white bg-black/50 px-1.5 py-0.5 rounded">APAR</span>
                                                </div>
                                            )}
                                            ...
                                            {inspection.selfie_url && (
                                                ...
                                                >
                                                    ...
                                                    <span className="absolute bottom-1 left-1 text-[10px] font-medium text-white bg-black/50 px-1.5 py-0.5 rounded">Selfie</span>
                                                </div>
                                            )}
                                                ...
                                                damage.damage_photo_url && (
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            alt={`Kerusakan ${idx + 1}`}
                                                            className="w-20 h-20 object-cover rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all border-red-200"
                                                        />
                                                        <div className="absolute top-0 right-0 -mt-1 -mr-1 bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full shadow-sm z-10">
                                                            Rusak
                                                        </div>
                                                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/20 rounded-lg">
                                                            <EyeIcon className="h-6 w-6 text-white drop-shadow-lg" />
                                                        </div>
                                                        <span className="absolute bottom-1 left-1 text-[10px] font-medium text-white bg-black/50 px-1.5 py-0.5 rounded truncate max-w-[70px]">
                                            ...
                                            {(!inspection.photo_url && !inspection.selfie_url && (!inspection.inspection_damages || inspection.inspection_damages.length === 0)) && (
                                                <div className="flex items-center justify-center w-20 h-20 bg-gray-50 rounded-lg border border-gray-200 border-dashed">
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    {inspection.repairApproval.supervisor_notes && (
                                                        <div className="mt-2 text-sm text-gray-700 bg-white/50 p-2 rounded border border-black/5">
                                                    ...
                                                    {inspection.repairApproval.status === 'rejected' && inspection.repairApproval.rejection_reason && (
                                                        <div className="mt-2 text-sm text-red-700 bg-red-100/50 p-2 rounded border border-red-200">
                                                            <div className="flex items-start gap-2">
